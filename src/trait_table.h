...
typedef struct trait_table_s {
    trait_impl_generic** generic_trait_impls;
    impl_list_for_type* impl_list_for_types;
    ureg impl_list_for_types_count;
    impl_status_for_type* impl_status_for_types;
    ureg impl_status_for_types_count;
    u8 impl_status_for_types_bitcount;
    u8 impl_list_for_types_bitcount;
    u8 generic_trait_impls_bitcount;
} trait_table;
