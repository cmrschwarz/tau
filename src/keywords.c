...
char* keyword_strings[] = {
    [KW_MODULE] = "module",   [KW_EXTEND] = "extend",
    [KW_REQUIRE] = "require", [KW_IMPORT] = "import",
    [KW_INCLUDE] = "include", [KW_CONST] = "const",
    [KW_MUT] = "mut",         [KW_SEALED] = "sealed",
    [KW_VIRTUAL] = "virtual", [KW_STATIC] = "static",
    [KW_AS] = "as",           [KW_FUNC] = "func",
    [KW_STRUCT] = "struct",   [KW_TRAIT] = "trait",
    [KW_AUTO] = "auto",       [KW_FOR] = "for",
    [KW_WHILE] = "while",     [KW_DO] = "do",
    [KW_LOOP] = "loop",       [KW_CONTINUE] = "continue",
    [KW_BREAK] = "break",     [KW_RETURN] = "return",
    [KW_LABEL] = "label",     [KW_GOTO] = "goto",
    [KW_IF] = "if",           [KW_SWITCH] = "switch",
    [KW_LET] = "let",         [KW_CONST] = "const",
    [KW_PUBLIC] = "public",   [KW_PROTECTED] = "protected",
    [KW_PRIVATE] = "private", [KW_INVALID_KEYWORD] = NULL,
};
